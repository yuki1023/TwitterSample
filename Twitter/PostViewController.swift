...
//                    }
                    ...
                    let url = "https://mbaas.api.nifcloud.com/2013-09-01/applications/TdaEXHzlIBzZMnxF/publicFiles/" + file.name
...
//                    print(error)
//                    SVProgressHUD.dismiss()
//                    let alert = UIAlertController(title: "ツイートのエラー", message: error!.localizedDescription, preferredStyle: .alert)
//                    let okAction = UIAlertAction(title: "OK", style: .default, handler: { (action) in
//
//                    })
//                    alert.addAction(okAction)
